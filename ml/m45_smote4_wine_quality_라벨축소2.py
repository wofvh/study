...
print(data['quality'].value_counts())  # 라벨 축소 
# 6    2198
# 5    1457
# 7     880
# 8     175
...
# 결과: 0.7244897959183674
# acc: 0.7244897959183674
# f1_macro: 0.43281630484888345
# f1_micro: 0.7244897959183674
#################################################

# 3,4 > 0 
# 5,6,7 > 1 
# 8,9 > 2
# 결과: 0.7275510204081632
# acc: 0.7275510204081632
# f1_macro: 0.4427870202765121
# f1_micro: 0.7275510204081632
#################################################

# 3,4,5 > 0 
# 6,7 > 1 
# 8,9 > 2
# 결과: 0.713265306122449
# acc: 0.713265306122449
# f1_macro: 0.4235541055649939
# f1_micro: 0.7132653061224491
#################################################
# 3,4 > 0 
# 5,6 > 1 
# 7,8,9 > 2
# 결과: 0.7214285714285714
# acc: 0.7214285714285714
# f1_macro: 0.4239683852384312
# f1_micro: 0.7214285714285713