...
# 최적의 매개변수 : RandomForestClassifier(max_depth=6, min_samples_leaf=3, n_estimators=200)최적의 파라미터: {'max_depth': 6, 'min_samples_leaf': 3, 'n_estimators': 200}
# 최적의 점수: 0.9582417582417582
