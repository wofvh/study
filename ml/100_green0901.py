...
x_train,x_test,y_train,y_test = train_test_split(train_data,label_data,train_size=0.91,shuffle=False,random_state=123)
...
with zipfile.ZipFile("D:\study_data\_data\green/submission0902.zip", 'w') as my_zip:
    for i in filelist:
        my_zip.write(i)
    my_zip.close()
print('Done')
