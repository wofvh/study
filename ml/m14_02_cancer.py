...
# 최적의 매개변수 : RandomForestClassifier(max_depth=8, min_samples_leaf=3, n_estimators=200)최적의 파라미터: {'n_estimators': 200, 'min_samples_leaf': 3, 'max_depth': 8}
# 최적의 점수: 0.9277777777777778
# model.score : 0.9736842105263158
# acc_score: 0.9736842105263158
# 최적의 튠 acc: 0.9736842105263158
# 걸린시간 : 16.93 초