...
print(x_data.shape[1]) #54
print(y_data.shape[1]) #8
...
#output layer
w4 = tf.compat.v1.Variable(tf.random_normal([20, 8]))
b4= tf.compat.v1.Variable(tf.zeros([8]))
...
# accuracy_score :  0.24957832776840727
