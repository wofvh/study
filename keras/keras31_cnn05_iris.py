...
#2. 모델구성
model = Sequential()
model.add(Conv2D(64, kernel_size=(2,2),   # 출력(4,4,10)                                       # 자르는 사이즈 (행,렬 규격.) 10= 다음레이어에 주는 데이터
                 padding='same',
                 input_shape=(2,2,1), activation= 'relu'))    #(batch_size, row, column, channels)       # N(장수) 이미지 5,5 짜리 1 흑백 3 칼라                                                                        
...
# #########################
# loss : 0.06517766416072845
# (45, 2, 2, 1) (45, 1)
# r2 : 0.9716542058104722
