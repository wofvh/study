...
model.add(SimpleRNN(350, input_shape=(3,1), return_sequences =True))     
model.add(LSTM(50, return_sequences =True))
model.add(Bidirectional(SimpleRNN(100, return_sequences =True)))     # [batch, timesteps(몇개씩 자르는지), feature=1(input_dim)]
