...
model.add(Conv1D(128, 2, input_shape=(12,1)))
model.add(Flatten())
# 10 = units, 3 = timesteps , 1 = feature 
# units * (feature +bias +units)                    # units를 한번더 해준다. 
# model.add(SimpleRNN(32))                          # RNN은 2차원으로 인식해서 바로 Dense적용가능.  
...
hist = model.fit(x_train, y_train, epochs=500, batch_size=50, verbose=1,
...
# Conv1D 
# loss :  25.556062698364258
# loss :  25.556062698364258
# RMSE :  41.47942210717974
# r2스코어 :  0.9473968602133909