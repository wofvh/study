...
np.save('d:/study_data/_save/_npy/project_train6_x.npy', arr =x_train)
np.save('d:/study_data/_save/_npy/project_train6_y.npy', arr =y_train)
np.save('d:/study_data/_save/_npy/project_test6_x.npy', arr =x_test)
np.save('d:/study_data/_save/_npy/project_test6_y.npy', arr =y_test)
