...
#2.모델
# model = Sequential()
# model.add(Dense(10, input_dim=(54,1,1)))
...
# input1 = Input(shape=(54,1,1))          # 컬럼3개를 받아드린다.
...
# dense4 = Dense(8, activation='relu')(drop2)
...
model.add(Conv2D(64, kernel_size=(1,1),   # 출력(4,4,10)                                       # 자르는 사이즈 (행,렬 규격.) 10= 다음레이어에 주는 데이터
                 padding='same',
                 input_shape=(54,1,1), activation= 'relu'))    #(batch_size, row, column, channels)       # N(장수) 이미지 5,5 짜리 1 흑백 3 칼라                                                                        
...
# cnn
# loss :  0.23243668675422668
# acc :  0.9037890588022685