...
model.add(Conv1D(128, 2, input_shape=(30,1)))
model.add(Flatten())
# 10 = units, 3 = timesteps , 1 = feature 
# units * (feature +bias +units)                    # units를 한번더 해준다. 
# model.add(SimpleRNN(32))                          # RNN은 2차원으로 인식해서 바로 Dense적용가능.  
...
hist = model.fit(x_train, y_train, epochs =200, batch_size = 320, 
                 verbose=1, 
...
#LSTM
# acc 스코어 : 0.9181286549707602
# 걸린시간 :  39.849205493927

# Conv1D
# acc 스코어 : 0.9590643274853801
# 걸린시간 :  11.32085371017456 
