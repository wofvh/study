...
model.add(Conv1D(128, 2, input_shape=(3,3)))
model.add(Flatten())
# 10 = units, 3 = timesteps , 1 = feature 
# units * (feature +bias +units)                    # units를 한번더 해준다. 
# model.add(SimpleRNN(32))                          # RNN은 2차원으로 인식해서 바로 Dense적용가능.  
...
model.compile(loss= 'mae', optimizer ='adam') #다중분류는 무조건 loss에 categorical_crossentropy
...
# Conv1D
# loss :  31.842281341552734
# RMSE :  49.481806737168235
# r2스코어 :  0.6145949460626862