...
from tensorflow.python.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, Conv1D, LSTM, Reshape #Flatten평평하게해라.  # 이미지 작업 conv2D 
...
# # scaler = MaxAbsScaler()                     # scaler 2차원만 받는다. 
# # scaler = RobustScaler()
# # scaler = MinMaxScaler() 
