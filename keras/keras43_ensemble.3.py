...
y1_test, y2_train, y2_test = train_test_split(x1,x2,x3,y,y2,
                                                    train_size=0.7, 
                                                    random_state=100
                                                    )
...
print(y2_train.shape,y2_test.shape)       # (85,) (15,)
# (85,) (15,)
...
# last_output3 = Dense(1)(output53)
      ...
      # 단순하게 엮는것.      
merge21 = Dense(1280, activation= 'relu',name ='mg12')(mergel)
...
model =Model(inputs =[input1, input2, input3], outputs= [last_output, last2_output])
...
hist = model.fit([x1_test, x2_test, x3_test], [y1_train, y2_train], epochs=500, batch_size=16,verbose=1,
