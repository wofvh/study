...
from tensorflow.python.keras.layers import Dense, Conv2D, Flatten, MaxPooling2D, Input #Flatten평평하게해라.  # 이미지 작업 conv2D 
...
hist = model.fit(x_train, y_train, epochs=50, batch_size=100,verbose=1,
