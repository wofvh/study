...
# np.save('d:/study_data/_save_npy/keras46_5_train_x.npy', arr=xy_train[0][0])
# np.save('d:/study_data/_save_npy/keras46_5_train_y.npy', arr=xy_train[0][1])
# np.save('d:/study_data/_save_npy/keras46_5_test_x.npy', arr=xy_test[0][0])
# np.save('d:/study_data/_save_npy/keras46_5_test_y.npy', arr=xy_test[0][1])
