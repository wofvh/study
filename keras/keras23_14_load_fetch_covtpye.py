...
#               optimizer ='adam', 
#               metrics='accuracy') 
#다중분류는 무조건 loss에 categorical_crossentropy
...
#model.save("./_save/keras23_14_load_fetch_covtpye.h5")
model = load_model("./_save/keras23_14_load_fetch_covtpye.h5")
...
# accuracy: 0.6528
# loss :  0.7731490135192871 
# save 이후 
# accuracy: 0.6528
# loss :  0.773149013519287
