...
#2. 모델구성
model = Sequential()
model.add(Dense(10, activation='selu', input_dim=9))
...
model.fit(x_train, y_train, epochs=5000, batch_size=80, verbose=1, validation_split=0.2, callbacks=[earlyStopping])
