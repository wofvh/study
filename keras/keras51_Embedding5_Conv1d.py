...
from tensorflow.python.keras.layers import Dense, LSTM, Embedding,Flatten,Conv1D  # input layer에서 Embedding 사용. 

model = Sequential()                        # input(13,5)
# model.add(LSTM(32,))
model.add(Embedding(input_dim=33, output_dim=10,input_length=6))   # input_dim = 단어사전개수
