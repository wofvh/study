...
np.save('d:/study_data/_save/_npy/keras49_6_train_x.npy', arr=xy_augumented[0][0])
np.save('d:/study_data/_save/_npy/keras49_6_train_y.npy', arr=xy_augumented[0][1])
