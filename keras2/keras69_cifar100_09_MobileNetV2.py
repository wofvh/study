...
from keras.applications import VGG16, Xception,ResNet50, ResNet101, InceptionV3, InceptionResNetV2, DenseNet121, MobileNetV2

models = MobileNetV2(weights='imagenet',include_top=False)
...
# 걸린시간 36.576396226882935
# loss 3.8706886768341064
# acc 0.12720000743865967

# 걸린시간 443.22209000587463
# loss 3.9186227321624756
# acc 0.550599992275238
