...
from keras.applications import VGG16, Xception,ResNet50, ResNet101, InceptionV3, InceptionResNetV2, DenseNet121, MobileNetV2,NASNetMobile

models = NASNetMobile(weights='imagenet',include_top=False)
