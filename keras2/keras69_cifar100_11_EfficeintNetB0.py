...
from keras.applications import VGG16, Xception,ResNet50, ResNet101, InceptionV3, InceptionResNetV2, DenseNet121, MobileNetV2,NASNetMobile,EfficientNetB0

models = EfficientNetB0(weights='imagenet',include_top=False)
...
start = time.time()
model.fit(x_train,y_train, epochs=8, batch_size=256,validation_split=0.2,callbacks=[es,reduced_lr])
end = time.time()-start
...
# models.trainable=False
# 걸린시간 55.707658767700195
# loss 4.608487129211426
# acc 0.013399999588727951

# model.trainable = False
# 걸린시간 55.55713176727295
# loss 4.667705535888672
