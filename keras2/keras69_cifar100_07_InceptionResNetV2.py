...
from keras.applications import VGG16, Xception,ResNet50, ResNet101, InceptionV3, InceptionResNetV2

models = InceptionResNetV2(weights='imagenet',include_top=False)
